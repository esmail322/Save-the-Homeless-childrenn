        ...
        >
          ...
          >
            ...
            <Link>
              ...
              <p className="pl-3 font-semibold">{t("signasdonar")}</p>
            </Link>
          </div>
          <div
            onClick={() => setPage(2)}
          ...
          >
            <Link>
              ...
              <p className="pl-2 font-semibold">{t("signasstudent")}</p>
            </Link>
          </div>
          <div
            onClick={() => setPage(3)}
          ...
          >
            <Link>
              ...
              <p className="pl-2 font-semibold">{t("signupasteacher")}</p>
            </Link>
          </div>
        </div>
