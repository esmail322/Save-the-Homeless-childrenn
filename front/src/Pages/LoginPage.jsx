      ...
      <section className="">
        ...
        >
          ...
          >
            ...
            <p className="pl-3 font-semibold">Sign-up as Donar</p>
          </div>
          <div
            onClick={() => setPage(2)}
            className={`h-28
          ...
          >
            ...
            <p className="pl-2 font-semibold">Sign up as student</p>
          </div>
          <div
            onClick={() => setPage(3)}
            className={`h-28
        ...
        <div className="flex justify-center pt-4 mb-16  ">
          {page == 1 && (
            <div action="" className=" w-96 bg-backgorund">
              ...
              <input
                ...
                placeholder="Email"
                value={donar.email}
                onChange={(text) => setDonar({ ...donar, email: text })}
              />
              <input
                type="password"
                className="block border bg-backgorund border-black w-full p-3 rounded mb-1"
                ...
                onCanPlay={(text) => setDonar({ ...donar, password: text })}
              />
              <input
                type="password"
          ...
          {page == 2 && (
            <div action="" className=" bg-backgorund w-96">
              <input
                type="text"
                className="block border bg-backgorund border-black w-full p-3 rounded mb-1"
                name="fullname"
            ...
            <div action="" className=" bg-backgorund w-96">
              ...
              <div className="flex flex-row mb-1 ">
                <select
                  ...
                  id=""
                >
                  <option value="">What do you want to teach ?</option>
                  <option value="">city</option>
                  <option value="">city</option>
                  <option value="">city</option>
                </select>
